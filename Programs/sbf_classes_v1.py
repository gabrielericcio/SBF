...
def run_part1(rms=0, remove_bkg=False) :
    ...
    tend_g=time.time()
    print('Initial Geometry model',geo0, "Fit time in seconds : %6.3f" %(tend_g-tini_g),'\n\n' )
    
    #Ellipse modeling
    tini_e=time.time()
    ellipse = Ellipse(masked_data, geometry=geo0,threshold=0.1)
    tend_e=time.time()
    print('Initial Ellipse model',ellipse,"Fit time in seconds : %6.3f" %(tend_e-tini_e),'\n\n' )
    ...
    print('Final Geometry model',geogxy, "Fit time in seconds : %6.3f" %(tend_g-tini_g),'\n\n' )
    
    #Ellipse model
    tini_e=time.time()
    ellipse = Ellipse(masked_data, geometry=geogxy,threshold=0.1)
    tend_e=time.time()
    print('Final Ellipse model',ellipse,"Fit time in seconds : %6.3f" %(tend_e-tini_e),'\n\n' )
...
def run_part2(alpha) :
    ...
    ######INITIALIZE INPUT PARAMETERS FROM GAL INSTANCE GENERATED BY INIT
    ...
    whtdata=1/(1/whtdata+alpha*moddata)   # 0.1, 1
