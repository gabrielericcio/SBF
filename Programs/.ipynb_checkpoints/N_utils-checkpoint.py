...
def sbf_aper_corr(catfilepath, rad_asec, gxyid, band,csmin,mfaint,mbright,threshold) :
    ...
    print('tclean_cpt[MAG_APER]',len(tclean_cpt))
    ...
    print('max(tbright_cpt[MAG_AUTO])',len(tbright_cpt['MAG_APER']))
    print('min(tbright_cpt[MAG_AUTO])',len(tbright_cpt['MAG_APER']))
